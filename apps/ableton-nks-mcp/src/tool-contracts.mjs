...
export const toolContracts = {
  ...
  duplicate_session_object: { description: "Plan or duplicate an exact Session scene or clip.", inputSchema: guarded({ targetType: { type: "string", enum: ["scene", "clip"] }, targetId: string("Stable source ID."), trackId: ids.trackId }, ["targetType", "targetId"]) },
