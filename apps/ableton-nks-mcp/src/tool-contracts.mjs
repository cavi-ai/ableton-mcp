...
export const toolContracts = {
  ...
  rename_rack_chain: { description: "Plan or rename an exact rack chain with a guarded hierarchy snapshot.", inputSchema: guarded({ trackId: ids.trackId, deviceId: ids.deviceId, chainId: string("Exact chain ID."), name: string("New layer name.") }, ["trackId", "deviceId", "chainId", "name"]) },
