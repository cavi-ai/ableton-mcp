...
export const toolContracts = {
  ...
  analyze_audio_file: { description: "Measure local source audio loudness, true peak, format, and optional first-channel spectral peaks. Not Live processing or pitch correction. Requires ffmpeg and ffprobe.", inputSchema: object({ sourcePath: string("Absolute local audio file."), includeSpectrum: boolean("Include one 4096-sample spectral frame at the window start."), startSeconds: number("Window start.", { minimum: 0 }), durationSeconds: number("Window duration, defaults to 10 seconds.", { exclusiveMinimum: 0, maximum: 60 }) }, ["sourcePath"]) },
  analyze_audio_clip: { description: "Measure an exact Session or Arrangement audio clip's local source file over a bounded window. Source-only, not rendered clip or track audio.", inputSchema: object({ trackId: ids.trackId, clipId: ids.clipId, includeSpectrum: boolean("Include one first-channel 4096-sample spectral frame."), startSeconds: number("Source window start.", { minimum: 0 }), durationSeconds: number("Source window duration, defaults to 10 seconds.", { exclusiveMinimum: 0, maximum: 60 }) }, ["trackId", "clipId"]) },
