...
export const toolContracts = {
  ...
  analyze_audio_file: { description: "Measure local source audio loudness, true peak, and format over a bounded window. Does not measure Live device processing or perform pitch correction. Requires ffmpeg and ffprobe.", inputSchema: object({ sourcePath: string("Absolute local audio file."), startSeconds: number("Window start.", { minimum: 0 }), durationSeconds: number("Window duration, defaults to 10 seconds.", { exclusiveMinimum: 0, maximum: 60 }) }, ["sourcePath"]) },
  analyze_audio_clip: { description: "Measure an exact Session or Arrangement audio clip's local source file over a bounded window. Source-only, not rendered clip or track audio.", inputSchema: object({ trackId: ids.trackId, clipId: ids.clipId, startSeconds: number("Source window start.", { minimum: 0 }), durationSeconds: number("Source window duration, defaults to 10 seconds.", { exclusiveMinimum: 0, maximum: 60 }) }, ["trackId", "clipId"]) },
